...
class Passaro:
    ...
    # calcular o deslocamento
        self.tempo += 0.5
        deslocamento = self.velocidade * self.tempo + 0.5 * (self.tempo**2)
...
def desenhar_tela(tela, background, passaros, canos, chao, pontos):
...
def main():
    ...
    while rodando:
        ...
        desenhar_tela(tela, background, passaros, canos, chao, pontos)
